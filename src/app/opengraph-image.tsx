    ...
    (
      <div
        style={{
          ...
          padding: "64px",
          background: "linear-gradient(135deg, #0d2b3a 0%, #15445c 55%, #1f6284 100%)",
          color: "#ffffff",
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: "24px" }}>
          ...
          <div style={{ fontSize: "60px", fontWeight: 700, letterSpacing: "-1.5px" }}>
            VistaTeacher
          </div>
        </div>

        <div style={{ display: "flex", flexDirection: "column", gap: "18px" }}>
          <div style={{ fontSize: "56px", lineHeight: 1.05, fontWeight: 700, maxWidth: "940px" }}>
            The network built for teachers
          </div>
          <div style={{ fontSize: "30px", lineHeight: 1.35, opacity: 0.95, maxWidth: "960px" }}>
